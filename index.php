    ...
    <div class="row align-items-center g-lg-5 py-5">
      ...
      <div class="col-md-10 mx-auto col-lg-5">
        <form class="p-4 p-md-5 border rounded-3 bg-body-tertiary" action="voting-list.php" method="post">
          <label for="floatingTextarea" class="pb-2">Write your favorite names:</label>
          <textarea class="form-control mb-3" rows="5" name="names" id="names" id="floatingTextarea"></textarea>
